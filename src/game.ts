...
class Game
{
	...
	constructor (seed?: uint32)
	{
		...
		this.randomizer = <Randomizer> new RandomizerBag(this.seed);
	}
}
...
class Gameplayer
{
	...
	public readonly clock: Clock<float>;
	private loopID: number;
	public readonly speed: float;

	constructor (canvas: HTMLCanvasElement, data: HTMLDataElement)
	{
		this.renderer = <Renderer> new WebGLRenderer(canvas);
	...
	public replay (gameplay: Gameplay): void
	{
